	...
	<tr height="50">
		<td align="center" width="150" bgcolor="yellow">
			<font size="5" color="white">
				<a href="mainSession.jsp?center=tent.jsp" style="text-decoration: none">텐트</a></font>
		</td>
		<td align="center" width="150" bgcolor="yellow">
			<font size="5" color="white">
		...
		<td align="center" width="150" bgcolor="yellow">
			<font size="5" color="white">
				<a href="mainSession.jsp?center=table.jsp" style="text-decoration: none">테이블</a></font>
		</td>
		<td align="center" width="150" bgcolor="yellow">
			<font size="5" color="white">
